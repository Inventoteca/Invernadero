...
//<Enum !Start!>
enum {E_PG_MAIN};
enum {E_ELEM_BTN1,E_ELEM_BTN2,E_ELEM_BTN3,E_ELEM_TEXT1};
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT1,E_PG_MAIN,(gslc_tsRect){124,7,72,16},
    (char*)"INICIO",0,E_BUILTIN10X16);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  
  // create E_ELEM_BTN1 button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN1,E_PG_MAIN,
    (gslc_tsRect){40,35,240,50},(char*)"CICLO CORTO",0,E_BUILTIN10X16,&CbBtnCommon);
  
  // create E_ELEM_BTN2 button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN2,E_PG_MAIN,
    (gslc_tsRect){40,95,240,50},(char*)"LAVADO ESTANDAR",0,E_BUILTIN10X16,&CbBtnCommon);
  
  // create E_ELEM_BTN3 button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN3,E_PG_MAIN,
    (gslc_tsRect){40,155,240,50},(char*)"ABRIR PUERTA",0,E_BUILTIN10X16,&CbBtnCommon);
//<InitGUI !End!>
